...
{
    public class CookMeatBase : GameTaskBase
    {
        public override GameTaskCodes Code => GameTaskCodes.CookMeat;

        public override GameTaskProvider Provider => GameTaskProvider.Room;

        public override bool Requires(GameState gameState)
        {
            bool isInValidRoom = gameState.Room.Name == nameof(RoomTemplate2.Galley);
